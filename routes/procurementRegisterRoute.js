...
router.get("/procurementRegister",  connectEnsureLogin.ensureLoggedIn(),  (req, res)=> { //to run on the browser and display form on server file
...
//post route for items registered to database
 router.post("/procurementRegister", async(req, res)=> {
  ...
  router.get("/procurementView",   connectEnsureLogin.ensureLoggedIn(),  async (req, res)=> {
    try {
 ...
 router.get("/procurementUpdate/:id",  connectEnsureLogin.ensureLoggedIn(),  async(req, res)=> { 
    try{
 ...
 router.post("/deleting", async(req, res)=> {
  ...
  router.get("/itemAvailableRegistered",  connectEnsureLogin.ensureLoggedIn(),  async (req, res)=> {
   try {
 ...
 router.get("/itemAvailable/:id",  connectEnsureLogin.ensureLoggedIn(),  async(req, res)=> { 
   try{
 ...
 router.post("/itemAvailable", async(req, res)=> {
  ...
  router.get("/itemFinishedRegistered",  connectEnsureLogin.ensureLoggedIn(),  async (req, res)=> {
   try {
  ...
  router.get("/itemFinished/:id",  connectEnsureLogin.ensureLoggedIn(),  async(req, res)=> { 
   try{
     const item = await ProcurementModel.findOne({_id: req.params.id});
